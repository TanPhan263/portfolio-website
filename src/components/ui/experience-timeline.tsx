...
const DesktopTimeline = ({
  ...
  return (
    <div className="hidden lg:flex w-full">
      ...
      <div className="w-3/5 flex flex-col gap-0 py-4 pr-4 shrink-0">
        {projects.map((proj, i) => (
          <div
            key={i}
            ref={el => {
          ...
          >
            ...
            <div className="absolute bottom-4 left-4 px-4 py-2 rounded-xl bg-black/50 backdrop-blur-sm z-10">
