...
const BentoCard = ({
  ...
  >
    <div>{background}</div>
    <div className="p-4">
      <div className={cn("pointer-events-none z-10 flex transform-gpu flex-col gap-1 transition-all duration-300", cta ? "lg:group-hover:-translate-y-10" :"")}>
        <Icon className="h-12 w-12 origin-left transform-gpu text-neutral-700 transition-all duration-300 ease-in-out scale-75 group-hover:scale-90" />
