...
const socialPosts = [
  {
    ...
    data: {
      status: 'My favorite framework ✨',
      tags: ['ReactJS', 'Nextjs', 'Vuejs', 'Nuxtjs'],
      images: [
        'react-logo.png',
        'next-logo.jpeg',
        'vue-logo.jpeg',
  ...
  },
  {
    ...
    data: {
      ...
      tags: ['Redux', 'ReactQuery'],
      images: ['redux-logo.png', 'react-query-logo.avif']
    }
  },
  {
    id: 3,
      ...
      <div className="flex flex-col gap-6">
              ...
              <div className="relative flex flex-1 flex-col gap-6">
                ...
                <div className="space-y-6 flex-1 flex flex-col items-center justify-center">
                  <h3 className="pt-0.5 text-lg font-bold text-balance text-black md:text-4xl dark:text-white">
                    Frontend is my playground, tech is my jam 🚀
                  </h3>
                  <h2 className="text-sm/[1.125rem] text-black md:text-base/[1.375rem] dark:text-neutral-400 [&_b]:md:font-semibold [&_strong]:md:font-semibold">
                    I’m all about learning, leading, and cracking tough
                    challenges — every experience is like a level-up for me and
                    the squad.
                  </h2>
                </div>
        ...
        >
          {socialPosts.map(({ id, variants, colSpan, order, data }) => (
            ...
            >
              <div className="relative h-full rounded-2xl border p-2 md:rounded-3xl md:p-3 col-span-1 md:col-span-2 lg:col-span-3">
                <GlowingEffect
                  blur={0}
                  borderWidth={3}
                  spread={80}
